...
The release workflow builds Linux, macOS, and Windows archives, publishes `SHA256SUMS.txt`, and creates GitHub artifact attestations from that checksum file.
