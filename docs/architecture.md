...
10. Peer messages and known peers are bounded by configured limits, inbound reads and outbound writes use configured timeouts, and malformed, oversized, incompatible, and rejected peer additions are counted in node snapshots.
